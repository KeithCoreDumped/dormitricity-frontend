...
import { computeEnergyPowerSeries, type Point } from "@/lib/utils";

type EnergyPowerChartProps = {
  history: Point[];
};

function EnergyPowerTooltip({ active, payload, label }: {
  active?: boolean;
...
export function EnergyPowerChart({ history }: EnergyPowerChartProps) {
  const { t, i18n } = useTranslation();
    ...
    <div className="h-96 w-full">
      <ResponsiveContainer width="100%" height="100%">
        ...
        >
          ...
          />
          <Tooltip content={<EnergyPowerTooltip />} />
          <Legend
            verticalAlign="top"
            height={32}
